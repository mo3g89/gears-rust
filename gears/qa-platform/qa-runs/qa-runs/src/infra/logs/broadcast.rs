...
//!
//! **Corrected 2026-08-31.** This read "or the log archiving feature 2.7
//! decouples". Feature 2.7 is *Serverless Execution & Runner Migration*
//! (`docs/DECOMPOSITION.md` §2.7), which is about running the workloads, not
//! about log durability; and the decoupling itself has since landed — the
//! durable copy is `qa_run_logs` (`infra::logs::RunLogArchive`). It does not
