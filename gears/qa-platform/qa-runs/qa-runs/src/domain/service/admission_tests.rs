...
pub(in crate::domain::service) mod fakes {
    ...
    impl CoveringSystemAuthZ {
        ...
        pub(in crate::domain::service) fn subject_tenants_for(&self, resource_id: Uuid) -> Vec<Uuid> {
    ...
    pub(in crate::domain::service) struct FakeEnvironments {
        ...
        /// Tenants whose `get_platform` calls are answered. Everything else is
        ...
        /// Tenants each `get_platform`/`list_variables` call was made under, so a
    ...
    impl QaEnvironmentsClientV1 for FakeEnvironments {
        /// **Tenant-filtered**, like `test_support::MockEnvironments::get_platform`
        ...
        async fn get_platform(
            ...
            Ok(TargetPlatform {
                ...
                // Task 5); this fixture predates it and has nothing to say
                // about cluster health, so it is `None`.
                cluster: None,
                created_at: stamp,
                updated_at: stamp,
            })
        ...
        async fn list_platforms(
            ...
            Err(env_unsupported("list_platforms"))
        }
        ...
        async fn create_platform(
            ...
            Err(env_unsupported("create_platform"))
        }
        ...
        async fn update_platform(
            ...
            Err(env_unsupported("update_platform"))
        }
        ...
        async fn delete_platform(
            ...
            Err(env_unsupported("delete_platform"))
        }
