...
impl QaEnvironmentsClientV1 for FakeQaEnvironments {
    async fn get_platform(
        ...
        _ctx: &SecurityContext,
        _id: Uuid,
    ) -> Result<TargetPlatform, qa_environments_sdk::QaEnvironmentsError> {
    ...
    async fn list_platforms(
        &self,
        _ctx: &SecurityContext,
    ) -> Result<Vec<TargetPlatform>, qa_environments_sdk::QaEnvironmentsError> {
    ...
    async fn create_platform(
        &self,
        _ctx: &SecurityContext,
        _new: qa_environments_sdk::NewPlatform,
    ) -> Result<TargetPlatform, qa_environments_sdk::QaEnvironmentsError> {
        unimplemented!("not on the read path")
    }
    ...
    async fn update_platform(
        ...
        _ctx: &SecurityContext,
        _id: Uuid,
        _patch: qa_environments_sdk::PlatformPatch,
    ) -> Result<TargetPlatform, qa_environments_sdk::QaEnvironmentsError> {
        unimplemented!("not on the read path")
    }
...
fn fixture_platform() -> TargetPlatform {
    TargetPlatform {
        id: PLATFORM_ID,
        name: "staging".to_owned(),
        product_id: None,
        description: None,
        kubeconfig_credstore_ref: "cred://kubeconfig".to_owned(),
        available: true,
...
async fn a_rebuilt_run_reaches_the_dashboard_and_the_overview() {
    ...
    assert!(!outcome.stopped_at_gap, "nothing should have failed to project");
