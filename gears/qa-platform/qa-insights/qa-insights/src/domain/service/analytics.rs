...
use crate::domain::ports::{CatalogReader, Clock, PlatformReader};
...
pub struct AnalyticsOverview {
    ...
    /// ([`PlatformReader::names`]' signature is shaped to make a per-row lookup
    ...
    /// executed, or in another tenant, which [`PlatformReader::names`]
    ...
    C: CollectRepository,
{
    ...
    /// `R`, `Arc<dyn CatalogReader>`, `Arc<dyn PlatformReader>`, `Arc<dyn Clock>`,
