...
//! * [`platform_reader`] — a platform id's display name, read from
//!   qa-environments (Task 25a, with its adapter; first called by Task 25b).
...
//!
//! **[`platform_reader`] was the third, and for one task it was the most extreme
...
pub use platform_reader::PlatformReader;
