...
///    already rejected once (`qa_environments_sdk::TargetPlatform::default_branch`
///    records that argument). **This is a real parity gap**, not a tidy-up:
...
/// `qa_environments_sdk::TargetPlatform::kubeconfig_credstore_ref` uses.
///
