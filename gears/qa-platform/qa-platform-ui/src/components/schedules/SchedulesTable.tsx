...
import { useCustomPlans, usePlans, usePlatforms } from '@/api/hooks';
    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableHead>Platform / ver.</TableHead>
      ...
      <TableBody>
        {schedules.map((schedule) => {
          ...
          const platform = schedule.platform ? platformByName.get(schedule.platform) : undefined;
          ...
          return (
            <TableRow key={schedule.name}>
              ...
              <TableCell className="tabular-nums">
                {schedule.platform ? (
                  <span title={`Platform ${schedule.platform}`}>
                    {schedule.platform}
