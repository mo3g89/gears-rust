...
#
# WHY THIS IS NEEDED AT ALL. `POST /qa/v1/platforms` REQUIRES a kubeconfig --
...
# `POST /qa/v1/platforms` with a raw `kubeconfig` writes there and never returns
...
#                      was given to POST /qa/v1/platforms. The Secret NAME is
