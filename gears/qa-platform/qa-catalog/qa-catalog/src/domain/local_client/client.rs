...
use qa_catalog_sdk::{
    BundleRequest, CustomPlan, NewCustomPlan, NewTestRepository, Plan, Product, QaCatalogClientV1,
    QaCatalogError, SshKey, SyncRequest, TestBundle, TestFileMeta, TestRepository,
...
impl QaCatalogClientV1 for QaCatalogLocalClient {
    ...
    async fn create_product(
        ...
        self.services
            .products
            .create_product(ctx, name, key, description, folder)
            .await
            .map_err(Into::into)
    }
    ...
    async fn update_product(
        ...
        self.services
            .products
            .update_product(ctx, id, name, key, description, folder)
            .await
            .map_err(Into::into)
    }
