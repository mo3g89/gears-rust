...
//! (`PlatformsService::run_observation_cycle`, `domain/service/platforms.rs`):
//! a system actor with no caller, enumerating every platform across every
...
const RATIFIED_EXCEPTION_FILE: &str = "src/domain/service/platforms.rs";
